...
import {ReadById, update} from '../../backendApi/CRUD'
...
const UpdateForm = (props) => {
  ...
  const updateData = ()=>{
   ...
   if(isEmpty(product_name)){
     ...
     update(props.id, product_name, product_code, product_image, product_price, product_quantity, totalPrice).then((result)=>{
